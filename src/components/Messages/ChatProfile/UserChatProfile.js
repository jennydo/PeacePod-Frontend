...
const UserChatProfile = ({chat}) => {
    ...
    <>
        <VStack
            ...
            spacing={0}
        >
            <Avatar className="chat-user-profile avatar" mb={3} name={username}
size='xl' src={avatar}/>
            <h3 className="chat-user-profile username">{username}</h3>
            <p>({pronounce})</p>
            <div className="chatbox-divider" />

            <UserChatProfileFeature features={userInfo} title="Get to know me"/>
            <UserChatProfileFeature features={chatAdjustment} title="Decorate your Chat box"/>
            <UserChatProfileFeature features={privacyAndSupport} title="Privacy & Support"/>
